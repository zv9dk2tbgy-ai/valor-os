...
export const seedCashFlowItems = [
  { id: "cfi-1", company_id: "co-sichin", project_id: "pr-chinotto", asset_id: null, type: "entrata", category: "Vendita immobiliare", description: "Incasso DCS", amount: 106000, due_date: null, actual_date: null, status: "previsto", probability: 60, source: "Brief utente 07/07/2026", responsible: null, notes: "Data da programmare.", simulateOff: false, demo: true },
  { id: "cfi-2", company_id: "co-sichin", project_id: "pr-chinotto", asset_id: null, type: "entrata", category: "Vendita immobiliare", description: "Incasso posti auto (rogiti)", amount: 160000, due_date: null, actual_date: null, status: "previsto", probability: 55, source: "Brief utente 07/07/2026", responsible: null, notes: "Posti auto venduti, in attesa di rogito notarile.", simulateOff: false, demo: true },
  ...
  { id: "cfi-10", company_id: "co-sichin", project_id: "pr-chinotto", asset_id: null, type: "entrata", category: "Finanziamento infragruppo", description: "Finanziamento Bowser → Sichin (ic-1)", amount: 20000, due_date: null, actual_date: null, status: "da formalizzare", probability: 40, source: "Brief utente 07/07/2026", responsible: null, notes: "Collegato a IntercompanyLoan ic-1.", simulateOff: false, demo: true },
];

export const seedDecisions = [
  { id: "dec-1", company_id: "co-sichin", project_id: "pr-chinotto", asset_id: null, title: "Confermare data incasso DCS (€106.000)", description: "Serve una data certa per pianificare la cassa H2 2026.", priority: "alta", cash_impact: 106000, risk_if_delayed: "Slitta la copertura del fabbisogno residuo (€130.782).", deadline: "2026-07-31", status: "aperta", responsible: null, demo: true },
  { id: "dec-2", company_id: "co-sichin", project_id: "pr-chinotto", asset_id: null, title: "Fissare la data dei rogiti posti auto (€160.000)", description: "Posti auto già venduti, manca la data di rogito notarile.", priority: "alta", cash_impact: 160000, risk_if_delayed: "Incasso rinviato, tensione di cassa in autunno.", deadline: "2026-08-31", status: "aperta", responsible: null, demo: true },
